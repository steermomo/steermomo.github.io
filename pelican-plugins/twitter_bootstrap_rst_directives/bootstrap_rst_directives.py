...
class CleanRSTReader(RstReader):
    ...
    def _get_publisher(self, source_path):
        extra_params = {"initial_header_level": "2", "syntax_highlight": "short", "input_encoding": "utf-8"}
    ...
    def get_image_element(self):
        ...
        if "target" in self.options:
            ...
            if target_type == "refuri":
                ...
                container_node = nodes.reference(refname=fully_normalize_name(data), name=whitespace_normalize_name(data))
